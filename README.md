...
## Environments
- Preview: https://main--edsda--AliaksandrMikhailauDataArt.aem.page/
- Live: https://main--edsda--AliaksandrMikhailauDataArt.aem.live/
...
1. Open the `edsda` directory in your favorite IDE and start coding :)
